...
parser.add_argument('--numgpus', help='Number of GPUs to use. Default is 1.', default=1, type=int)
...
def main(_):
  # Create estimator
  if args.numgpus > 1:
    strategy = tf.contrib.distribute.MirroredStrategy(num_gpus=args.numgpus)
